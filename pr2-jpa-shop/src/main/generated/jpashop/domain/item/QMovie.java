...
public class QMovie extends EntityPathBase<Movie> {
    ...
    private static final long serialVersionUID = -1563974526L;
    ...
    //inherited
    public final ListPath<jpashop.domain.Category, jpashop.domain.QCategory> categories = _super.categories;
    ...
    //inherited
    public final ListPath<jpashop.domain.OrderItem, jpashop.domain.QOrderItem> orderItems = _super.orderItems;
